...
# social-scan.sh
# Reddit + X API scan for BD scouting
# Usage:
#   ./scripts/social-scan.sh "topic" [hours]
...
WORKDIR="/home/clawdbot/.openclaw/workspace"
...
X_ENV_FILE="$HOME/.config/social-scan/.env"
X_TOKEN_FILE="/home/clawdbot/x-bearer-token.txt"
...
# Prefer token file for consistency with validated manual terminal flow
